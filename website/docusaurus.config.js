const config = {
  ...
  themeConfig: {
    ...
    announcementBar: {
      ...
      content: '⚠️ This is a <strong>Preview Environment</strong> for PR #32. Changes may not be final. <strong>Do not use in production.</strong>',
